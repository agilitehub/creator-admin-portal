...
const _BasicForm = ({ data, isNewRecord }) => {
  ...
  return (
    <Row justify='center'>
      <Col span={16}>
        <Card type='inner' title='New Record'>
          <Form
          ...
          >
              ...
              <Col span={10}>
                <Form.Item>
                  ...
                  <Form.Item
                    ...
                    rules={[
                      { required: Templates.dataModel.name.required, message: Templates.dataModel.name.validationMsg }
                    ]}
                  >
                ...
                <Form.Item>
                  ...
                  <Form.Item
                    ...
                    rules={[
                      { required: Templates.dataModel.age.required, message: Templates.dataModel.age.validationMsg }
                    ]}
                  >
                ...
                <Form.Item>
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: Templates.dataModel.gender.required,
                        message: Templates.dataModel.gender.validationMsg
                      }
                    ]}
                  >
                    <Select
            ...
            <Row style={{ marginTop: 10 }}>
              ...
              <Form.Item noStyle>
                <Button style={{ backgroundColor: Theme.twitterBootstrap.danger, color: 'white' }} onClick={closeTab}>
                  Cancel
                </Button>
              </Form.Item>
            </Row>
